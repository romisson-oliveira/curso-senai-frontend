...
### Anotações
<!-- Abaixo segue suas anotações -->
```

Abra seu arquivo rascunho.html e monte a seguinte estrutura básica:

- Crie 3 títulos h1 (Vamos observar algo importante sobre isso).
- Crie 2 títulos h2.
- Crie 3 parágrafos p abaixo de cada h2.

No `<head>` do seu HTML, logo abaixo do `<title>`, crie a tag:
...
- Pergunta: Quem ganhou a briga? A cor do Inline ou a cor do Interno?
